                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center space-x-2">
                                                @can('edit customers')
                                                <a href="{{ route('customers.edit', $customer) }}" class="p-2 text-amber-500 hover:bg-amber-50 rounded-lg transition-colors" title="Edit Customer">
                                                ...
                                                <form action="{{ route('customers.destroy', $customer) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="p-2 text-rose-500 hover:bg-rose-50 rounded-lg transition-colors" title="Delete Customer">
